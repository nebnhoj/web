...
<template>
  <div v-if="profile" class="relative overflow-hidden">
    <section id="hero" class="mx-auto max-w-6xl px-6 py-16">
      <p class="mb-4 inline-block rounded-full border border-base-300 bg-base-100 px-4 py-2 text-xs font-black uppercase tracking-[0.15em]">
      ...
      <div class="mt-8 flex flex-wrap gap-3">
        <a href="#experience" class="btn btn-neutral">View Experience</a>
        <a :href="mailtoLink" class="btn btn-outline">Contact Me</a>
      </div>
    </section>
    ...
    <section id="experience" class="mx-auto max-w-6xl px-6 py-10">
      ...
      <div class="mt-6 space-y-5">
        <article v-for="item in profile.experience" :key="`${item.company}-${item.period}`" class="rounded-3xl border border-base-300 bg-base-100 p-6">
    ...
    <section id="skills" class="mx-auto max-w-6xl px-6 py-10">
      ...
      <div class="mt-6 grid gap-4 md:grid-cols-2">
        <article v-for="(items, category) in profile.skills" :key="category" class="rounded-3xl border border-base-300 bg-base-200 p-5">
    ...
    <section id="awards" class="mx-auto max-w-6xl px-6 py-10">
      ...
      <div class="mt-6 grid gap-4 md:grid-cols-2">
        <article class="rounded-3xl border border-base-300 bg-base-100 p-6">
    ...
    <section id="contact" class="mx-auto max-w-6xl px-6 pb-24 pt-10">
      <div class="rounded-[2.5rem] border border-base-300 bg-neutral p-8 text-neutral-content">
        ...
        <div class="mt-5 flex flex-wrap gap-3">
          <a :href="profile.links.linkedin" target="_blank" rel="noopener noreferrer" class="rounded-full border border-neutral-content/40 px-4 py-2 font-bold">LinkedIn</a>
          <a :href="profile.links.github" target="_blank" rel="noopener noreferrer" class="rounded-full border border-neutral-content/40 px-4 py-2 font-bold">GitHub</a>
          <a :href="profile.links.googlePlay" target="_blank" rel="noopener noreferrer" class="rounded-full border border-neutral-content/40 px-4 py-2 font-bold">Google Play</a>
        </div>
      </div>
    </section>
  </div>
